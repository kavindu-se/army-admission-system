...
export default function ReviewQueue() {
  ...
  const [viewMode, setViewMode] = useState(
    () => localStorage.getItem("reviewQueue.viewMode") || "pending"
  );
  ...
  useEffect(() => {
    localStorage.setItem("reviewQueue.viewMode", viewMode);
  }, [viewMode]);
      ...
      <aside className="dashboard-sidebar">
        ...
        <nav className="side-menu">
          {isAdmin ? (
            ...
            <button className="side-link active" onClick={() => navigate("/review")}>
              PENDING/ACTIONS
            </button>
          )}
        </nav>
